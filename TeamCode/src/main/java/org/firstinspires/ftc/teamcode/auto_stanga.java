 ...
 * a metre, then strafes a metre to the left and stops.
 *
 * THE ARM
 ...
 * still.
 */
@Autonomous(name = "auto_stanga", group = "Auto")
public class auto_stanga extends LinearOpMode {
    ...
    private static final double DISTANCE_MM = 750;
